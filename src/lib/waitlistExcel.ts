...
/**
 * Generates an Excel file with ALL waitlist entries.
 ...
 */
export const generateWaitlistExcel = (entries: WaitlistEntry[]) => {
  ...
  const fileName = `EXCHKR_Waitlist_${Date.now()}.xlsx`
